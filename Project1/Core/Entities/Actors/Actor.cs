...
public sealed class Actor : Entity
{
    ...
    internal Workplace Workplace => this.Town?.Shops.GetShop(this); // replaced this.town with this.net.map.town because when the actor leaves the map, this.town returns null
