...
static class ItemDefOf
{
    ...
    static public readonly ItemDef Helmet = new ItemDef("ItemHelmet", typeof(Entity))
    {
        ...
        GearType = GearSlotDefOf.Head,
        ApparelProperties = new ApparelDef(GearSlotDefOf.Head, 10),
    ...
    static public readonly ItemDef Gear = new ItemDef("Tool", typeof(Entity))
    {
        ...
        MadeFromMaterials = true,
        GearType = GearSlotDefOf.Mainhand,
        DefaultMaterial = MaterialDefOf.Iron,
        CraftingProperties = CraftingProperties.ToolCraftingProperties,
        NameGetter = e => e.Def.LabelReadable,
        VariantType = typeof(GearProfileDef),
        StorageFilterVariations = Def.Get<GearProfileDef>(),
