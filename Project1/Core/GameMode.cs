...
abstract class GameMode
{
    ...
    internal virtual void ChunkReceived(Server server, int playerid, MapId mapid, IntVec2 chunkCoords) { }
    ...
    internal virtual void AllChunksReceived(NetEndpoint net, MapId mapid) { }
}
