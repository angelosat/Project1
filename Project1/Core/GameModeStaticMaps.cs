...
{
    readonly CommandParserMap Parser = new();
    ...
    public GameModeStaticMaps()
    {
        ...
        this.GameComponents.Add(new AIManager());
    ...
    public override void ParseCommand(NetEndpoint net, string command)
    {
    ...
    {
        return SaveFileManager.InitGui();
    }
