...
public class InteractionTarget : Inspectable, ITooltippable, IContextable, ISelectable, ILabeled, ISerializableNewNew<InteractionTarget>
{
   ...
   public MapBase? Map
    ...
    InteractionTarget() { }
    public InteractionTarget(BlockEntity blockEntity)
    {
        this.BlockEntity = blockEntity;
        this.Type = TargetType.BlockEntity;
        this._resolvedMap = blockEntity.Map;
    }
    public InteractionTarget(Entity obj)
    {
    ...
    public InteractionTarget(EntityRefId entityID)
    {
        this.Type = TargetType.Entity;
        this.EntityID = entityID;
    }
    public InteractionTarget(WorldBase world, EntityRefId entityID)
    {
        this.World = world;
        this.Type = TargetType.Entity;
        this.EntityID = entityID;
    }
    public InteractionTarget(Entity obj, Vector3 face)
    {
        this.Type = TargetType.Entity;
        this.EntityID = obj.RefId;
    ...
    //    this.Global = global;
    //}
    public InteractionTarget(MapBase map, Vector3 global)
    {
        //this._resolvedMap = map;
        this.Map = map;
        this.World = map.World;
    ...
    //    this.Precise = precise;
    //}
    public InteractionTarget(MapBase map, Vector3 global, Vector3 face, Vector3 precise)
    {
        this.Type = TargetType.Cell;
        //this._resolvedMap = map;
        this.Map = map;
    ...
    public InteractionTarget(MapId mapid, Vector3 global, Vector3 face, Vector3 precise)
    {
        this.Type = TargetType.Cell;
        this._mapID = mapid;
        this.Global = global;
    ...
    public InteractionTarget(WorldBase world, GameObjectSlot slot)
    {
        this.World = world;
        this.Type = TargetType.Slot;
        this.Slot = slot;
    }
    public InteractionTarget(GameObjectSlot slot)
    {
        this.World = slot.Owner.World;
        this.Type = TargetType.Slot;
        this.Slot = slot;
    }
    public InteractionTarget(Vector2 direction)
    {
        this.Type = TargetType.Direction;
        this.Direction = direction;
    }

    public InteractionTarget Clone()
    {
        var copy = new InteractionTarget
        {
            Type = this.Type,
            Global = this.Global,
            Face = this.Face,
    ...
    public InteractionTarget(MapBase map, Vector3 global, GameObjectSlot slot)
    {
        this.World = map.World;
        this.Map = map;
        if (slot == null)
    ...
    public InteractionTarget Write(BinaryWriter w)
    {
    ...
    //    }
    //}
    static public InteractionTarget Read(WorldBase world, IDataReader reader)
    {
        ...
        switch (type)
        {
            ...
            case TargetType.Entity:
                ...
                return new InteractionTarget(world, netID);
            ...
            case TargetType.Slot:
                ...
                return new InteractionTarget(world, slot);
            ...
            case TargetType.BlockEntitySlot:
                ...
                return new InteractionTarget(mapBe, vector3, s);

            case TargetType.Direction:
                return new InteractionTarget(reader.ReadVector2());
    ...
    public InteractionTarget(SaveTag tag)
    {
        this.Load(tag);
    }

    public InteractionTarget(WorldBase world, SaveTag tag)
    {
        this.World = world;

        this.Load(tag);
    }
    public InteractionTarget(MapBase map, SaveTag tag)
    {
        this.World = map.World;
        this._resolvedMap = map;
        this.Load(tag);
    ...
    static readonly public InteractionTarget Null = new();
    ...
    public bool IsEqual(InteractionTarget target)
    {
    ...
    public bool IsEqualFace(InteractionTarget target)
    {
        if (this.Type != target.Type)
            return false;
        if (this.Type == TargetType.Entity && this.Object != null && this.Object == target.Object)
    ...
    public static implicit operator GameObject(InteractionTarget b) => b.Object;
    public static implicit operator Entity(InteractionTarget b) => b.Object as Entity;
    public static implicit operator Actor(InteractionTarget b) => b.Object as Actor;

    public static implicit operator InteractionTarget(Entity obj)
    {
        return new InteractionTarget(obj);
    }
    public static implicit operator InteractionTarget((MapBase map, Vector3 global) location)
    {
        return new InteractionTarget(location.map, location.global);
    }
    ...
    {
        if (obj is not InteractionTarget o) return false;
    ...
    public static InteractionTarget Create(IDataReader r)
    {
        var type = (TargetType)r.ReadInt32();
        return type switch
        {
            TargetType.Null => InteractionTarget.Null,
            TargetType.Entity => new InteractionTarget(r.ReadEntityRefId()),
            TargetType.Cell => new InteractionTarget(r.ReadMapId(), r.ReadVector3(), r.ReadVector3(), r.ReadVector3()),
            TargetType.Slot => throw new NotImplementedException(),
            TargetType.BlockEntitySlot => throw new NotImplementedException(),
            TargetType.Direction => new InteractionTarget(r.ReadVector2()),
