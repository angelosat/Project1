...
{
    [Obsolete]
    public class CraftOrderOld : Inspectable, ISerializableNew<CraftOrderOld>, IListable
    {
        enum CraftMode { XTimes, UntilX, Forever }

        static readonly Dictionary<int, CraftOrderOld> References = new();
        ...
        public static CraftOrderOld GetOrder(int id)
        {
        ...
        public CraftOrderOld()
        {

        }
        public CraftOrderOld(int id, Reaction reaction, MapBase map, IntVec3 workstation)
           : this(reaction)
        {
            this.Map = map;
        ...
        public CraftOrderOld(Reaction reaction)
        {
        ...
        CraftOrderOld(SaveTag tag) : this(null, tag)
        {

        }
        CraftOrderOld(MapBase map, SaveTag tag)
        {
        ...
        public CraftOrderOld Read(IDataReader r)
        {
            this.ID = r.ReadInt32();
        ...
        public CraftOrderOld(MapBase map, IDataReader r)
        {
            this.Read(map, r);
        }
        ...
        internal static CraftOrderOld Load(SaveTag t)
        {
            var order = new CraftOrderOld(t);
            var id = order.ID;
        ...
        [Obsolete]
        public void ShowDetailsUI(Action<CraftOrderOld, string, ItemDef[], MaterialDef[], MaterialTypeDef[]> callback)
        {
        ...
        public static CraftOrderOld Create(IDataReader r) => new CraftOrderOld().Read(r);
    }
}
