...
namespace Project1.Core.Materials
{
    ...
    static class MaterialTypeDefOf
    {
        ...
        static public readonly MaterialTypeDef Metal = new("Metal", MaterialChemistryDefOf.Inorganic) { ReactionClass = ReactionClass.Tools, JobToExtract = JobDefOf.Miner, SkillToRefine = SkillDefOf.Smithing };
        ...
        static public readonly MaterialTypeDef Wood = new("Wood", MaterialChemistryDefOf.Organic) { ReactionClass = ReactionClass.Tools, JobToExtract = JobDefOf.Lumberjack, Shininess = .8f };
