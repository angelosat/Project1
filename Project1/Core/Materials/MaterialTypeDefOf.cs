...
namespace Project1.Core.Materials
{
    ...
    {
        static public readonly MaterialTypeDef Soil = new("Soil", MaterialChemistryDefOf.Inorganic) { JobToExtract = DutyDefOf.Digger };
        static public readonly MaterialTypeDef Stone = new("Stone", MaterialChemistryDefOf.Inorganic) { JobToExtract = DutyDefOf.Miner };
        static public readonly MaterialTypeDef Metal = new("Metal", MaterialChemistryDefOf.Inorganic) { JobToExtract = DutyDefOf.Miner, SkillToRefine = SkillDefOf.Smithing };
        ...
        static public readonly MaterialTypeDef Wood = new("Wood", MaterialChemistryDefOf.Organic) { JobToExtract = DutyDefOf.Lumberjack, Shininess = .8f };
