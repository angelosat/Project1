...
public sealed class Client : NetEndpoint
{
    ...
    public ConsoleBoxAsync GetConsole()
    {
    ...
    private readonly MyPriorityQueue<long, Packet> IncomingOrdered = new();
    private readonly MyPriorityQueue<long, Packet> IncomingOrderedReliable = new();
    private readonly MyPriorityQueue<long, Packet> IncomingSynced = new();
    ...
    {
        var r = packet.Reader;
        var thisWorldTick = this.World.CurrentTick;
        throw new Exception();
    ...
    private void HandleBufferedTimestampedNew()
    {
        ...
        while (this.BufferTimestampedNew.Count != 0)
        {
            ...
            var currenttick = this.World.CurrentTick;
    ...
    internal void AddPlayer(PlayerData player)
    {
        ...
        LobbyWindow.RefreshPlayers(this.Players.GetList());
