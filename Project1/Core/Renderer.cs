...
public sealed class Renderer : IDrawContext, /*ICamera,*/ IInputEventHandler
{
    ...
    public void PrepareShader(MapViewport viewport)
    {
        ...
        //var near = viewport.GetFarDepth();
        //var far = viewport.GetNearDepth();
        var far = viewport.GetFarDepth();
        var near = viewport.GetNearDepth();

        //var nearScaled = -near * zoom;
        //var farScaled = -far * zoom;
        ...
        this.Effect.Parameters["DepthResolution"].SetValue(2 / depthDiff);
    ...
    public void PrepareShaderTransparent(MapViewport viewport)
    {
        ...
        this.Effect.Parameters["DepthResolution"].SetValue(2 / depthD);
    ...
    private void NewDraw(MapViewport viewport, GraphicsDevice gd, EngineArgs a, SceneState scene, ToolManager toolManager, UIManager ui)
    {
        ...
        this.Effect = fx;
        //var xx = 0;// this.CameraOffset.X / w;
        //var yy = 0;// this.CameraOffset.Y / h;
    ...
    private static void SetBlockTextures(Effect fx)
    {
        fx.Parameters["s"].SetValue(Block.Atlas.Texture);
    ...
    private void DrawEntities(RenderContext ctx, SceneState scene, List<Entity> objs)
    {
