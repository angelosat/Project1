    ...
    class RoomGui : GroupBox, ISelectionBound
    {
        ...
        public RoomGui()
        {
            this.AddControlsVertically(
                new ComboBoxFinal<RoomRoleDef>(128, "Role", r => r?.LabelReadable ?? "none", setRoomDef, () => currentRoom?.RoomRole, () => currentRoom.Furnitures.SelectMany(f => RoomSystem.ByFurniture(f)).Distinct().Prepend(null)),
