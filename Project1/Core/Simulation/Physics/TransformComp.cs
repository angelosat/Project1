...
public sealed class TransformComp : EntityComp
{
    ...
    //public static Rectangle GetScreenBounds(MapViewport viewport, SpriteComp sprComp, Vector3 global)
    //{
    //    viewport.CullingCheck(global.X, global.Y, global.Z, sprComp.Sprite.GetBounds(), out Rectangle bounds);
    //    return bounds;
    //}
