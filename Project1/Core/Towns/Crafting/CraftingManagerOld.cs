...
namespace Project1.Core.Towns.Crafting
{
    public class CraftingManagerOld : TownComponent
    {
        ...
        {
            pReaget = Project1.Core.Base.Registry.PacketHandlers.Register(CraftingOrderToggleReagent);
            pPriority = Project1.Core.Base.Registry.PacketHandlers.Register(CraftingOrderModifyPriority);
            pQuantity = Project1.Core.Base.Registry.PacketHandlers.Register(CraftingOrderModifyQuantity);
            pRestrictions = Project1.Core.Base.Registry.PacketHandlers.Register(SetOrderRestrictions);
