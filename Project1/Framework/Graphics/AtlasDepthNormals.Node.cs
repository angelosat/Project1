        ...
        public partial class Node : Inspectable
        {
            ...
            public void Split(int w, int h)
            {
                if (w < h)
                {
                    ...
                    Node right = new(new Rectangle(this.X + w, this.Y, this.Width - w, this.Height));
                    Node left = new(new Rectangle(this.X, this.Y + h, w, this.Height - h));
                ...
                else
                {
                    ...
                    Node bottom = new(new Rectangle(this.X, this.Y + h, this.Width, this.Height - h));
                    Node top = new(new Rectangle(this.X + w, this.Y, this.Width - w, h));
