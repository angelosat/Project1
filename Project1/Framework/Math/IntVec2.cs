...
namespace Project1.Framework.Math
{
    public struct IntVec2 : IEquatable<IntVec2>
    {
        ...
        public IntVec2(Vector2 vector2) : this((int)System.Math.Round(vector2.X), (int)System.Math.Round(vector2.Y))
        {

        }
        public IntVec2(float x, float y) : this((int)System.Math.Round(x), (int)System.Math.Round(y))
        {
