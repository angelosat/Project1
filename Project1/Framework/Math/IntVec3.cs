...
namespace Project1.Framework.Math
{
    public struct IntVec3 : IEquatable<IntVec3>
    {
        ...
        public IntVec3(Vector3 vector3) : this((int)System.Math.Round(vector3.X), (int)System.Math.Round(vector3.Y), (int)System.Math.Floor(vector3.Z))
        {

        }
        public IntVec3(float x, float y, float z) : this((int)System.Math.Round(x), (int)System.Math.Round(y), (int)System.Math.Floor(z))
        {
