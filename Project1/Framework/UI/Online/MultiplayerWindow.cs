...
namespace Start_a_Town_
{
    class MultiplayerWindow : Window
    {
        ...
        private void Host()
        {
            ...
            Project1.Framework.Net.Client.Instance.Connect(localHost, new PlayerData(this.Txt_Name.Text), a => { LobbyWindow.Instance.Console.Write("Connected to " + localHost); });
        ...
        private void ConnectTo(string address)
        {
            ...
            Task.Factory.StartNew(() =>
                Project1.Framework.Net.Client.Instance.Connect(address, new PlayerData(this.Txt_Name.Text), ar =>
                {
