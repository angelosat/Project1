...
public class PictureBoxNew : ButtonBaseNew
{
    ...
    public PictureBoxNew(Rectangle bounds, float scale)
    {
    ...
    public PictureBoxNew(Vector2 size, Action<RenderTarget2D> renderer, Alignment.Horizontal halign = Alignment.Horizontal.Left, Alignment.Vertical valign = Alignment.Vertical.Top)
    {
    ...
    public PictureBoxNew(Vector2 location, Texture2D sprite, Rectangle? sourcerect, Alignment.Horizontal halign = Alignment.Horizontal.Left, Alignment.Vertical valign = Alignment.Vertical.Top)
        : base(location)
    {
        this.Sprite = sprite;
    ...
    public PictureBoxNew(Entity item, float scale)
        : this(item.Body.RenderIcon(item, scale))
    {
    }
    [Obsolete]
    public PictureBoxNew(Bone bone, float scale)
    {
    ...
    public PictureBoxNew(IAtlasNodeToken token) : this(Vector2.Zero, token.Atlas.Texture, token.Rectangle)
    {
    }
    public PictureBoxNew(Texture2D texture2D, Rectangle? rectangle = null, float scale = 1)
