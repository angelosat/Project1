...
namespace Project1.Framework.UI
{
    class SliderNewInt : Control
    {
        ...
        public int NextValue, PrevValue;
        readonly Func<int> ValueGetter;
        readonly Action<int> ValueSetter;
        ...
        public SliderNewInt(Func<int> valueGetter, Action<int> valueSetter, int width, int min = 0, int max = 100, int step = 1, string format = null)
            : base()
        {
        ...
        private void UpdateNextValue()
        {
            ...
            this.NextValue = (int)(System.Math.Round(newValue) * this.Step);
            //var newValue = (this.Min + mousePerc * (this.Max - this.Min)) / this.Step;
