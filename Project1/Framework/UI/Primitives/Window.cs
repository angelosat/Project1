...
public class Window : Control
{
    ...
    {
        if (this.Location.X + this.Width > UIManager.Width && this.Width <= UIManager.Width)
            this.Location.X = UIManager.Width - this.Width;
        if (this.Location.Y + this.Height > UIManager.Height && this.Height <= UIManager.Height)
            this.Location.Y = UIManager.Height - this.Height;
    }

    internal void AddMiniButton(IconButton btn)
    {
        //btn.Location = this.CloseButton.Location - btn.Width * Vector2.UnitX;
        //this.Controls.Add(btn);
        this.CornerButtons.AddControlsTopRight(btn);
        this.Controls.Remove(this.CornerButtons);
        //this.CornerButtons.Location = this.CloseButton.Location - this.CornerButtons.Width * Vector2.UnitX;
        this.CornerButtons.AnchorTo(() => this.CloseButton.LocationFunc(), Vector2.UnitX);
        this.Controls.Add(this.CornerButtons);
    }
}
