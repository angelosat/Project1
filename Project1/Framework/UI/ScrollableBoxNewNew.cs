...
namespace Project1.Framework.UI
{
    ...
    public class ScrollableBoxNewNew : GroupBox
    {
        ...
        public override void HandleMouseWheel(System.Windows.Forms.HandledMouseEventArgs e)
        {
            ...
            this.Client.ClientLocation.Y = System.Math.Min(0, System.Math.Max(this.Client.Height - this.Client.ClientSize.Height, this.Client.ClientLocation.Y + step * e.Delta));
        }
        ...
        {
            this.Client.ClientLocation.Y = System.Math.Min(this.Client.ClientLocation.Y, -lowestVisiblePoint + this.Client.Size.Height);
        }
        ...
        {
            this.Client.ClientLocation.Y = System.Math.Max(this.Client.ClientLocation.Y, System.Math.Min(0, this.Client.Size.Height - this.Client.ClientSize.Height));
        }
    }
}
