...
public class ScrollableBoxNewNewNew : GroupBox
{
        ...
        : base(width, height)
    {
        ...
        this.UpdateScrollbars();
        this.ButtonSnapToBottom = new IconButton(Icon.ArrowDown, this.EnableAutoscroll) { Location = new(this.Viewport.Width, this.Viewport.Height), Anchor = new(1.1f) };
    }
    ...
    private void EnableAutoscroll()
    {
        if (this.Autoscroll)
            return;
        this.VScroll.SnapToBottom();
        this.Autoscroll = true;
        this.Controls.Remove(this.ButtonSnapToBottom);
    }
    ...
    private void DisableAutoscroll()
    {
        ...
        this.Controls.Add(this.ButtonSnapToBottom);
    }
