...
namespace Start_a_Town_.Components
{
    public class SpriteComp : EntityComp//<SpriteComp.Spec>
    {
        ...
        public SpriteComp()
        {
            return; // the component should be created totally empty
            this.Hidden = false;
            this.Sprite = Sprite.Default;
            this.Body = Bone.Create(BoneDefOf.Torso, Sprite);
        ...
        internal override void Resolve() //InitializeOnce()// 
        {
        ...
        {
            //this.Body ??= this.DefaultBody = this.Owner.Def.Body.Clone();
        ...
        //    }
        //    protected override void ApplyDefaultsTo(SpriteComp comp)
        //    {
        ...
        //        {
        //            foreach (var (bone, texture) in this.Overrides)
        //                this.RootBone[bone].Sprite = texture;
        //        }

        //        throw new NotImplementedException("copy to defaults");
        //    }
        //}
    ...
    //            this.Body = Bone.Create(BoneDefOf.Torso, this.Sprite);
    //            this.DefaultBody = this.Body;
    ...
    //        {
    //            //this.Body = this.Owner.Def.Body;
    //            //Body.MakeChildOf(this.Owner);
