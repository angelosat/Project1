...
namespace Start_a_Town_
{
    class TaskBehaviorDigging : BehaviorExecutePlan
    {
        ...
        protected override IEnumerable<Behavior> GetSteps()
        {
            ...
            yield return new BehaviorBeginInteraction(TargetIndex.A);// this.Actor.Map.GetBlockMaterial(this.Task.GetTarget(0).Global).Type.SkillToExtract.GetInteraction());
