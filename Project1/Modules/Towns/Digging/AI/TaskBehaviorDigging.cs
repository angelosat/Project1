...
namespace Start_a_Town_
{
    class TaskBehaviorDigging : BehaviorExecutePlan
    {
        ...
        {
            this.FailOnNoDesignation(TargetIndex.A, DesignationDefOf.Mine);
            ...
            yield return new BehaviorResolveInteraction(TargetIndex.A);// this.Actor.Map.GetBlockMaterial(this.Task.GetTarget(0).Global).Type.SkillToExtract.GetInteraction());
