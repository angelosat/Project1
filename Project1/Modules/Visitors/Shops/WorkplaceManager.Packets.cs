...
namespace Start_a_Town_
{
    public partial class WorkplaceManager
    {
        ...
        public class Packets
        {
            ...
            static public void SendPlayerAddShoppingArea(INetwork net, int playerID, int shopID, int stockpileID)
            {
                if (shopID < 0)
                    return;
                var w = net.GetOutgoingStream();
            ...
            private static void ReceivePlayerAddShoppingArea(INetwork net, BinaryReader r)
            {
                var playerID = r.ReadInt32();
                var shopid = r.ReadInt32();
                var stockpileid = r.ReadInt32();
