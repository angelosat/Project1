namespace Start_a_Town_
{
    ...
    static internal class MaterialRefinementDefOf
    {
        ...
        static public readonly MaterialRefinementDef Ingots = new("Ingots", Ore, MaterialTypeDefOf.Metal, ItemContent.BarsGrayscale);

        static public readonly MaterialRefinementDef Logs = new("Logs", null, MaterialTypeDefOf.Wood, ItemContent.LogsGrayscale);
